...
<title>SANMAN BNV TRAVELS</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>You've come to the right portal. We will assist you the best!!! </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>We are firmly determined on building a travel management system for Sanman
BNV travels who have been managing it manually for 23 years now. The website
allows the customer to book a car for their travel according to their convenient date
and number of people travelling.</p>
    </div>
    <div class="row"> 
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            ...
            <p>Experience the best Comfort</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
